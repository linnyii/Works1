...
<body>
	...
	<div class="container">
		<center><h1>CodeGym 資料庫設計＿修改操作</h1></center>
		<form method="post" action="UpdateEmployees">
			<div class="form-group col-md-6">
			  <label for="example-text-input" class="col-2 col-form-label">Employee ID</label>
			  <font size="1">填入員工編號Employee ID</font>	
			  <div class="col-10">
			    <input class="form-control" type="text" value="" name="employeeid" placeholder="Employee ID">
		    
			  </div>
				
			  <label for="example-text-input" class="col-2 col-form-label">Last Name</label>
			  <font size="1">填入欲更改後的Last Name</font>
			  <div class="col-10">
			  ...
			  <label for="example-text-input" class="col-2 col-form-label">First Name</label>
			   <font size="1">填入欲更改後的First Name</font>
			  <div class="col-10">
			  ...
			  <font size="1">填入欲更改後的Birth date</font>
			  <div class="col-10">
			  ...
			  <div class="col-sm-">		       
               ...
               function relocate_insert()
               {
                ...
                <input type="button" class="btn btn-primary" value="前往刪除" onclick="relocate_delete()">
               <script>
               function relocate_delete()
               {
                  location.href = "http://localhost:8080/webDemo/gotoDelete.jsp";
                } 
                </script> 
